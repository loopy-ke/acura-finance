...
Route::middleware(['web', 'auth'])->prefix('credit')->name('credit.')->group(function () {
    ...
    Route::get('customers/search', [CreditApplicationController::class, 'searchCustomers'])
        ->name('customers.search');

    // Credit Products
    Route::resource('products', \LoopyLabs\CreditFinancing\Controllers\CreditProductController::class);
    
    // Credit Applications - Three Step Process
    Route::get('applications/export', [CreditApplicationController::class, 'export'])
        ->name('applications.export');
    Route::get('applications/create/step-1', [CreditApplicationController::class, 'createStep1'])
        ->name('applications.create.step1');
    Route::post('applications/create/step-2', [CreditApplicationController::class, 'createStep2'])
        ->name('applications.create.step2');
    Route::post('applications/create/step-3', [CreditApplicationController::class, 'createStep3'])
        ->name('applications.create.step3');
    Route::resource('applications', CreditApplicationController::class)->except(['create']);
